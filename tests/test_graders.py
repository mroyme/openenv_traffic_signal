...
class TestCorridorGrader:
    ...
    def test_zero_time_perfect_score(self):
        assert corridor_grader.grade(0.0, 20.0) == 1.0

    def test_same_as_baseline(self):
        assert corridor_grader.grade(20.0, 20.0) == 0.0

    def test_worse_than_baseline_clipped(self):
        assert corridor_grader.grade(30.0, 20.0) == 0.0

    def test_zero_baseline(self):
        assert corridor_grader.grade(10.0, 0.0) == 0.0
...
class TestGridGrader:
    ...
    def test_zero_wait_perfect_score(self):
        assert grid_grader.grade(0.0, 10.0) == 1.0

    def test_same_as_baseline(self):
        assert grid_grader.grade(10.0, 10.0) == 0.0

    def test_worse_than_baseline_clipped(self):
        assert grid_grader.grade(15.0, 10.0) == 0.0

    def test_zero_baseline(self):
        assert grid_grader.grade(5.0, 0.0) == 0.0
...
class TestEmergencyGrader:
    def test_perfect_emergency_and_civilian(self):
        assert emergency_grader.grade(0.0, 200.0, 0.0, 10.0) == 1.0

    def test_worst_emergency_and_civilian(self):
        assert emergency_grader.grade(200.0, 200.0, 10.0, 10.0) == 0.0
    ...
    def test_zero_max_and_baseline(self):
        assert emergency_grader.grade(10.0, 0.0, 5.0, 0.0) == 0.0
